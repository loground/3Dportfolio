...
const FallingText = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-[1] w-full h-full cursor-pointer text-center pointer-events-none pt-8 overflow-hidden"
      onClick={trigger === 'click' ? handleTrigger : undefined}
      onMouseOver={trigger === 'hover' ? handleTrigger : undefined}>
      {/* Aurora Background */}
      <div style={{ touchAction: 'auto' }} className="pointer-events-none absolute inset-0 z-[0]">
        <Aurora
